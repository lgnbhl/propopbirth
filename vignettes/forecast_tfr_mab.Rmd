...
|          |                                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                    |
|          |                                                                                                        | -   z1_prop: the Bézier function also uses the **slope at the end point** of the temporal period. The parameter `z1_prop` is the proportion of the precalculated slope (according to the trend model) that is used as slope of the curve at the end point. This parameter is responsible for the curve shape at the **transition between the temporal and the constant period**.                   |
+----------+--------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
temporal_end_tfr <- tidyr::expand_grid(
  ...
  nat = c("ch", "int")) |> 
  dplyr::mutate(y_end = c(0.8, 0.8, 1.0, 2.0, 1.2, 1.3))
...
forecast_tfr_example2 <- forecast_tfr_mab(
  topic = "tfr", 
  input_dataset = input$tfr,
  trend_model = c("ARIMA", 2024, 2026, trend_past = 7, trend_prop = 0.5),
  temporal_model = c(
    "Bezier", 2027, 2055, trend_prop = 0.8, z0_prop = 0.7, z1_prop = 0
  ),
  temporal_end = NA,
  constant_model = c("constant", 2056, 2075)
  ) 
...
forecast_tfr_example3 <- forecast_tfr_mab(
  ...
  trend_model = c("lm", 2024, 2026, trend_past = 7, trend_prop = 0.5),
  temporal_model = c(
    "Bezier", 2027, 2055, trend_prop = 0.3, z0_prop = 0.7, z1_prop = 0
  ),
  temporal_end = NA,
  constant_model = c("constant", 2056, 2075)
  ) 
