...
First, the **mean annual population** is calculated for females within the so-called 'fertile age' (usually 15 to 49). For each group (e.g. spatial unit, age, nationality). The mean population of a given year is calculated by the average of the population at the beginning and the end of the year.
